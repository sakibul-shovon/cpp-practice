// File Name: Bitwise_Operators.cpp
// Date: 2024-06-28
// Time: 17:36:59
...
int main()
{
    ...
    for(ll i=1;i<a;i++){
        for(ll j=i+1;i<=a;i++){
            ...
            if(And > maxAnd and And < b) maxAnd = And;
            if(Or > maxOr and Or < b) maxOr = Or;
            if(XOR > maxXor and XOR < b) maxXor = XOR;

        }
    }

    cout<<maxAnd<<endl<<maxOr<<endl<<maxXor<<endl;
    return 0;
}
