// File Name: A_Alphabet_Animals.cpp
// Date: 2025-12-04
// Time: 19:12:46
...
int main()
{
    ...
    {
        string test = v[i];
        char last = test[test.size() - 1];
        // first last same
        if (test[0] == target and test[0] == last)
        {
