// File Name: Usain_Bolt_vs_Tiger.cpp
// Date: 2025-11-10
// Time: 19:09:34
...
int main()
{
    ...
    While(T)
    {
        ll finish, distance, a, v;
        cin >> finish >> distance >> a >> v;
        ll boltS = finish;
        ll tigerS = finish + distance;

        double tigerTime = sqrt(double(2.0 * tigerS) / double(a));
        double boltTime = double(boltS) / double(v);
